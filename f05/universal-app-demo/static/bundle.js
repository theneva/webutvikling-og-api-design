...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StateWrapper = __webpack_require__(160);

	var _StateWrapper2 = _interopRequireDefault(_StateWrapper);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  _App2.default,
	  null,
	  _react2.default.createElement(_StateWrapper2.default, { active: true })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StateWrapper = function (_React$Component) {
	  _inherits(StateWrapper, _React$Component);

	  function StateWrapper(props) {
	    _classCallCheck(this, StateWrapper);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(StateWrapper).call(this, props));
	  ...
	  _createClass(StateWrapper, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      if (this.props.active) {
	        ...
	        setTimeout(function () {
	          return _this2.setState({ message: 'bananas!' });
	        }, 1000);
	      } else {
